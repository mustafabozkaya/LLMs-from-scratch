...
data = [
    ...
    },
    {
        ...
        "response": "E=mc² formülü, Einstein'ın görecelilik teorisinden ku خورشur ve enerji (E), kütle (m) ve ışık hızının karesi (c²) arasındaki ilişkiyi gösterir.",
    },
    {
        "instruction": "İstanbul'un ünlü müzeleri nelerdir?",
        "response": "İstanbul'un ünlü müzeleri arasında Topkapı Sarayı, Hagia Sophia, İstanbul Arkeoloji Müzesi, Türk ve İslam Eserleri Müzesi ve Pera Müzesi bulunur.",
    },
]
